...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="container box-white">
                <form action="/layanan/{{ $layanan->id }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_alat" id="exampleFormControlInput1"
                            placeholder="Sebutkan nama Alatnya" value="{{ $layanan->nama_alat }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="deskripsi_layanan" id="exampleFormControlTextarea1"
                            placeholder="Deskripsikan layanan nya !"
                            rows="5">{{ $layanan->deskripsi_layanan }}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="harga_layanan" id="exampleFormControlInput1"
                            placeholder="Sebutkan nama Alatnya" value="{{ $layanan->harga_layanan }}">
                    </div>
                    ...
                    <select name="kategori_id" class="form-select" aria-label="Default select example">
                        <option value="{{ $layanan->kategori_id }}" selected hidden>{{
                            optional($layanan->kategori)->nama_kategori }}</option>
                    ...
                    <div class="col-sm-5 mb-2">
                        <div class="text-center">
                            <img class="img-preview img-fluid" src="{{ asset('gambar/' . basename($layanan->gambar)) }}"
                                alt="">
                        </div>
                    </div>
    ...
    <script>
        function previewImage() {
            ...
            const defaultImage = "{{ asset('path_to_default_image.jpg') }}"; // Change this to the path of your default image

            if (image.files.length === 0) {
                // No file selected, display default image
